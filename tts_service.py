...
class TTSService:
    ...
    def _select_provider(self, language: str):
        """CP1 has no engine router; availability is checked by the registry."""
    ...
    def validate_request(self, request: TTSRequest) -> tuple[str, str, str, float, str, str | None, str | None]:
        ...
        # provider capability (a CP2 provider's capabilities()
    ...
    def _run(self, job: _Job):
        ...
        try:
            ...
            # voice profile (provider capability - validate_request()
            ...
            # confidently-silent leading/trailing samples. The prior provider
            ...
            # provider. Voice cloning has no such split: it is a
            # provider capability (validate_request already refuses
